...
const translations = {
  fr: {
    ...
    'work.renameEpic': "Renommer l'epic",
    'work.renameEpicPrompt': "Nouveau titre de l'epic :",
    'work.deleteEpic': "Supprimer l'epic",
    'work.deleteEpicConfirm': "Supprimer l'epic « {title} » et toutes ses stories et tâches ?",
    'work.renameStory': 'Renommer la story',
    'work.renameStoryPrompt': 'Nouveau titre de la story :',
    'work.deleteStory': 'Supprimer la story',
    'work.deleteStoryConfirm': 'Supprimer la story « {title} » et toutes ses tâches ?',
    'work.editEpic': "Modifier l'epic (titre + phase)",
    'work.epicTitle': "Titre de l'epic",
    'work.epicPhase': 'Phase :',
    'work.epicPhaseNone': 'Aucune phase',
    'work.save': 'Enregistrer',
    'work.cancel': 'Annuler',
    'work.progressTitle': '{pct} % terminé ({total} tâche·s)',
    'work.task': 'Tâche',
    'work.total': 'Total',
    ...
    'constraint.alap': 'ALAP (au plus tard)',
    ...
    'capacity.capacityLabel': 'Capacité',
  ...
  en: {
    ...
    'work.renameEpic': 'Rename epic',
    'work.renameEpicPrompt': 'New epic title:',
    'work.deleteEpic': 'Delete epic',
    'work.deleteEpicConfirm': 'Delete epic “{title}” and all its stories and tasks?',
    'work.renameStory': 'Rename story',
    'work.renameStoryPrompt': 'New story title:',
    'work.deleteStory': 'Delete story',
    'work.deleteStoryConfirm': 'Delete story “{title}” and all its tasks?',
    'work.editEpic': 'Edit epic (title + phase)',
    'work.epicTitle': 'Epic title',
    'work.epicPhase': 'Phase:',
    'work.epicPhaseNone': 'No phase',
    'work.save': 'Save',
    'work.cancel': 'Cancel',
    'work.progressTitle': '{pct}% done ({total} task(s))',
    'work.task': 'Task',
    'work.total': 'Total',
    'work.today': 'Today',
    ...
    'constraint.alap': 'ALAP (as late as possible)',
